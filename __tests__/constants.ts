...
export const TEST_EARTHO_CLIENT_QUERY_STRING = `&earthoOneClient=${encodeURIComponent(
  btoa(
    JSON.stringify({
      name: 'one-client-js',
      version: version
...
export const TEST_DOMAIN = 'eartho_domain';
export const TEST_CLIENT_ID = 'eartho_client_id';
