...
import com.eartho.one.result.OptionalCredentials
...
public class SecureCredentialsManager @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE) internal constructor(
     ...
     * @param apiClient the Eartho Authentication API Client to handle token refreshment when needed.
    ...
    private fun continueGetCredentials(
        ...
        serialExecutor.execute {
            ...
            val hasEmptyCredentials =
                TextUtils.isEmpty(credentials.idToken) && TextUtils.isEmpty(credentials.idToken) || cacheExpiresAt == null
    ...
    internal companion object {
        ...
        private const val KEY_CREDENTIALS = "com.eartho.one.credentials"
        private const val KEY_EXPIRES_AT = "com.eartho.one.credentials_access_token_expires_at"
        private const val KEY_CACHE_EXPIRES_AT = "com.eartho.one.credentials_expires_at"
        private const val KEY_CAN_REFRESH = "com.eartho.one.credentials_can_refresh"
        private const val KEY_ALIAS = "com.eartho.one.key"
    }
