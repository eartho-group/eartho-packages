...
import com.eartho.one.result.DatabaseUser

/**
 * Represent a request that creates a user in a Eartho Database connection and then logs in.
 */
 ...
 */(
     ...
     *
     * @see [User Metadata documentation]()
     */
