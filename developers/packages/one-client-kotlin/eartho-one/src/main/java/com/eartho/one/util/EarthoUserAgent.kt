...
import com.eartho.one.BuildConfig
import com.eartho.one.request.internal.GsonProvider
import java.nio.charset.StandardCharsets
import java.util.*

/**
 * Responsible for building the custom user agent header data sent on requests to Eartho.
 */
public class EarthoUserAgent public constructor(
    ...
    public companion object {
        public const val HEADER_NAME: String = "Eartho-Client"
        private const val NAME_KEY = "name"
        private const val VERSION_KEY = "version"
        private const val ENV_KEY = "env"
        private const val LIBRARY_VERSION_KEY = "eartho.one.android"
