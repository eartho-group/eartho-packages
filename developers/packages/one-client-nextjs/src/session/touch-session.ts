...
import { get, set, SessionCache } from '.';
 ...
 * ```js
 * // app/my-api/route.js
 * import { touchSession } from '@eartho/one-client-nextjs';
 *
 ...
 * import { touchSession } from '@eartho/one-client-nextjs/edge'; // Note the /edge import
 *
