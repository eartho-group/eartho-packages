...
/**
 *  Represents an error during a request to the EarthoOne Authentication API.
 *
 *  - See: [Standard Error Responses](https://eartho.com/docs/api/authentication#standard-error-responses)
 */
public struct AuthenticationError: EarthoOneAPIError {
    ...
    /// When an EarthoOne rule returns an error.
    ...
    /// When EarthoOne denies access due to some misconfiguration or an error in an Action or Rule.
