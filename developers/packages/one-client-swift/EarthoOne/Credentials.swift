...
/**
 User's credentials obtained from EarthoOne.
 */
@objc(A0Credentials)
public final class Credentials: NSObject {
    ...
    ///
    /// - See: [Access tokens](https://eartho.com/docs/security/tokens/access-tokens)
    ...
    ///
    /// - Important: The ID tokens obtained from Web Auth login are automatically validated by EarthoOne.swift, ensuring their
    /// contents have not been tampered with. **This is not the case for the ID tokens obtained from the Authentication API
    /// client.** You must [validate](https://eartho.com/docs/security/tokens/id-tokens/validate-id-tokens) any ID
    /// Tokens received from the Authentication API client before using the information they contain.
    /// - See: [ID tokens](https://eartho.com/docs/security/tokens/id-tokens)
    public let idToken: String
    /// Granted scopes.
    ///
    /// - See: [Scopes](https://eartho.com/docs/get-started/apis/scopes)
    public let scope: String?
    /// MFA recovery code that the application must display to the user, to be stored securely for future use.
    ///
    /// - See: [MFA Recovery Codes](https://eartho.com/docs/mfa/configure-recovery-codes-for-mfa)
