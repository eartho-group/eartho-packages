...
/**
 Client for the Users endpoints of the EarthoOne [Management API v2](https://eartho.com/docs/api/management/v2).
...
public protocol Users: Trackable, Loggable {
    ...
    /**
     ...
     ```
     EarthoOne
         .users(token: credentials.accessToken, domain: "samples.eartho.com")
         .get("user id")
         .start { result in
             switch result {
     ...
     - See: [Management API Endpoint](https://eartho.com/docs/api/management/v2#!/Users/get_users_by_id)
     */
    ...
    /**
     ...
     ```
     let attributes = UserPatchAttributes().email("newemail@eartho.com",
     ...
     - See: [Management API Endpoint](https://eartho.com/docs/api/management/v2#!/Users/patch_users_by_id)
     */
    ...
    /**
     ...
     - See: [Management API Endpoint](https://eartho.com/docs/api/management/v2#!/Users/post_identities)
     - See: [User Account Linking](https://eartho.com/docs/users/user-account-linking)
     */
    ...
    /**
     ...
     EarthoOne
         .users(token: credentials.accessToken, domain: "samples.eartho.com")
         .link("primary user id", userId: "secondary user id", provider: "eartho", connectionId: "connection id")
         .start { print($0) }
     ```
     ...
     - Parameters:
       ...
       - provider:     Name of the provider for the secondary user, for example 'eartho' for database connections.
    ...
    /**
     ...
     - Requires: The token must have the scope `update:users`.
     - See: [Management API Endpoint](https://eartho.com/docs/api/management/v2#!/Users/delete_user_identity_by_user_id)
     - See: [User Account Linking](https://eartho.com/docs/users/user-account-linking)
     */
