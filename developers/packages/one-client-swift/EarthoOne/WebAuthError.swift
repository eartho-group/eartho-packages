 ...
 */
public struct WebAuthError: EarthoOneError {
    ...
    public var debugDescription: String {
        ...
        case .pkceNotAllowed: return "Unable to perform authentication with PKCE."
            + " Enable PKCE support in the settings page of the EarthoOne application, by setting the"
    ...
    /// The EarthoOne application does not support authentication with Proof Key for Code Exchange (PKCE).
    /// PKCE support needs to be enabled in the settings page of the [EarthoOne application](https://manage.eartho.com/#/applications/),
