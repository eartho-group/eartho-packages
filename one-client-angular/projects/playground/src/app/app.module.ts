...
import { AuthModule } from 'projects/one-client-angular/src/lib/auth.module';
import { AuthHttpInterceptor } from 'projects/one-client-angular/src/lib/auth.interceptor';
...
import {
  AuthClientConfig,
  AuthConfig,
} from 'projects/one-client-angular/src/lib/auth.config';
