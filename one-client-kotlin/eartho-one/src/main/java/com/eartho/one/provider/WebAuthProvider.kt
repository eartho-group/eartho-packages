...
public object WebAuthProvider {
     ...
     */
    @JvmStatic
    public fun logout(account: EarthoOneConfig): LogoutBuilder {
     ...
     *
     * @param config to use for authentication
     * @return a new Builder instance to customize.
     */
    @JvmStatic
    public fun login(config: EarthoOneConfig): AccessBuilder {
        return AccessBuilder(config)
    }
    ...
    public class LogoutBuilder internal constructor(private val account: EarthoOneConfig) {
         ...
         * the [Log Users Out of Identity Provider]() article.
         *
         * @return the current builder instance
         */
        ...
        public fun start(context: Context, callback: Callback<Void?, AuthenticationException>) {
            ...
            val logoutManager =
                LogoutManager(account, callback, returnToUrl!!, ctOptions, federated)
            managerInstance = logoutManager
            logoutManager.startLogout(context)
        }
    }

    public class AccessBuilder internal constructor(private val account: EarthoOneConfig) {
        public fun withAccessId(accessId: String): Builder {
            if (accessId.isEmpty()) throw IllegalArgumentException();
            return Builder(account,accessId)
        }
    }
    ...
    public class Builder internal constructor(
         ...
         * Defaults to the value returned by [EarthoOneConfig.getDomainUrl].
         *
