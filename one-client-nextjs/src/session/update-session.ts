...
import { get, set, Session, SessionCache } from '.';
 ...
 * ```js
 * // app/my-api/route.js
 * import { getSession, updateSession } from '@eartho/one-client-nextjs';
 *
 ...
 * import { getSession, updateSession, withServerAccessRequired } from '@eartho/one-client-nextjs';
 *
 ...
 * ```js
 * // app/my-page/page.js
 * import { getSession, updateSession } from '@eartho/one-client-nextjs/edge'; // Note the /edge import
 *
 * export default async function Page() {
 *   async function updateUser(updates) {
 *     'use server';
