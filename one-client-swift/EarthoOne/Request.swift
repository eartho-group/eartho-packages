...
#if DEBUG
let parameterPropertyKey = "com.eartho.parameter"
#endif

/**
 EarthoOne API request.
 ...
 ```
 */
public struct Request<T, E: EarthoOneAPIError>: Requestable {
    /**
...
public extension Request {
    ...
    /**
     ...
     - Throws: An error that conforms to ``EarthoOneAPIError``; either an ``AuthenticationError`` or a ``ManagementError``.
     */
    #if compiler(>=5.5.2)
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.2, *)
